...
S2_files_dir= "data/GEE_downloads/drive-download-20230502T113951Z-001/ANNA_S2_ALL"
S2_files <- list.files(S2_files_dir, pattern = "*.tif$")
S2_files_full <- list.files(S2_files_dir, pattern = "*.tif$", full.names = TRUE)

modis_albe_dir <- "data/GEE_downloads/drive-download-20230502T113951Z-001/ANNA_MODIS_ALBE_ALL"
...
modis_brdf_dir <- "data/GEE_downloads/drive-download-20230502T113951Z-001/ANNA_MODIS_BRDF_ALL"
...
lapply(as.integer(rownames(df_files)), FUN=function(x){
  Albedo_all_calculator(path_s2 = df_files[x,"S2_full"],
                        ...
                        output_dir = "data/output_data/Indiv_albe_V7",
...
wd1 <- 'C:/Users/anna/OneDrive - Office365.boku.ac.at/data/output_data/Indiv_albe_V7/BluSA_ntb'
...
# export as .tif files #
output_dir2 <- "C:/Users/anna/OneDrive - Office365.boku.ac.at/data/output_data/Indiv_albe_V7"
