...
# read data # 
df <- read_excel("input_data/plots/plot-data.xlsx", sheet = "data") #plot-level stand data 
radiation <- read_excel("input_data/radiation_data/radiation_krycklan.xlsx", sheet = "data") #mean monthly and annual sw downward solar radiation over krycklan from NASA portal
